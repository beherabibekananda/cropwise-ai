...
import { datasetStats } from "@/mock-data";
...
const classes = [
  { name: "Apple Scab", acc: 98.4, n: 24800 },
  { name: "Tomato Late Blight", acc: 97.1, n: 31200 },
  { name: "Maize Rust", acc: 96.5, n: 18400 },
  { name: "Grape Powdery Mildew", acc: 95.8, n: 15600 },
  { name: "Potato Early Blight", acc: 94.9, n: 21000 },
  { name: "Wheat Septoria", acc: 93.7, n: 17900 },
];
      ...
      <div className="grid lg:grid-cols-3 gap-6 mt-6">
        ...
        <div className="space-y-6">
          <div className="glass-strong rounded-3xl p-6 shadow-elegant">
            ...
            <p className="text-xs text-muted-foreground mt-1">Ensemble of EfficientNet-B4, ConvNeXt-Tiny, and ViT-S/16 with calibrated softmax voting.</p>
            <div className="mt-3 grid grid-cols-3 gap-2 text-center">
              {["EfficientNet", "ConvNeXt", "ViT"].map((m) => (
          ...
          <div className="glass-strong rounded-3xl p-6 shadow-elegant">
            ...
            <p className="text-xs text-muted-foreground mt-1">Aggregated from PlantVillage, PlantDoc, in-house field captures from 12 countries, and laboratory-validated samples.</p>
          </div>
        </div>
      </div>
    </div>
