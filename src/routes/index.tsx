...
function Dashboard() {
  return (
    <div className="max-w-[1400px] mx-auto">
      <TopBar title="Good morning, Amara" subtitle="Your fields are healthy. 2 alerts need review." />
      ...
      >
        ...
        <div className="relative max-w-2xl">
          <span className="inline-flex items-center gap-1.5 text-xs font-medium px-3 py-1 rounded-full bg-white/15 backdrop-blur">
            <Sparkles className="size-3" /> Ensemble CNN v2.4 · 98.6% accuracy
          </span>
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
        ...
        <StatCard label="Avg confidence" value="94.2%" delta="+0.6%" icon={Sparkles} />
      </section>
