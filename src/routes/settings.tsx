  ...
  return (
    <div className="max-w-[900px] mx-auto">
      ...
      <div className="glass-strong rounded-3xl shadow-elegant overflow-hidden">
        <Row Icon={User} title="Profile" desc="Amara Mwangi · Field Agronomist">
        ...
        <Row Icon={Globe} title="Region" desc="Nakuru, Kenya · East Africa">
          <button className="text-xs font-medium px-3 py-1.5 rounded-full glass hover:bg-accent/60">Change</button>
        </Row>
        <Row Icon={Moon} title="Dark mode" desc="Comfortable at dawn and dusk">
          <Toggle />
        </Row>
